...
DefinitionBlock ("D:\ApplePlan\CLover\DSDTEditor-Linux-Mac-Win\dsdt.aml", "DSDT", 1, "HPQOEM", "HP      ", 0x00000000)
{
    ...
    Name (BCTL, 0x80)
    Name (PCHG, 0x01F4)
    OperationRegion (GNVS, SystemMemory, 0x9AFB3C98, 0x00000203)
    ...
    Method (GBTI, 1, NotSerialized)
    {
        ...
        If (\_SB.PCI0.LPCB.EC0.ECAV ())
        {
            ...
            If (LEqual (Arg0, Zero))
            {
                If (LEqual (\_SB.PCI0.LPCB.EC0.GBTT (Zero), Zero))
                {
                ...
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BFCH, BFCL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x03))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x02))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BRCH, BRCL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x05))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x04))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BMEH, BMEL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x07))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x06))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BCYH, BCYL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x09))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x08))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BTMH, BTML), Local1)
                Subtract (Local1, 0x0AAA, Local1)
                Divide (Local1, 0x0A, Local2, Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x0B))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x0A))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BVTH, BVTL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x0D))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x0C))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BCRH, BCRL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x0F))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x0E))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BDVH, BDVL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x11))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x10))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BBSH, BBSL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x13))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x12))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BV1H, BV1L), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x15))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x14))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BV2H, BV2L), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x17))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x16))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BV3H, BV3L), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x19))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x18))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BV4H, BV4L), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x1B))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x1A))
                Store (\_SB.PCI0.LPCB.EC0.ITSN (ToBCD (\_SB.PCI0.LPCB.EC0.RDMW (BSNH, BSNL)), 0x05), Local1)
                Concatenate (Local1, " ", Local4)
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BMDH, BMDL), Local1)
                And (Local1, 0x01E0, Local2)
                ShiftRight (Local2, 0x05, Local2)
                Store (\_SB.PCI0.LPCB.EC0.ITSN (ToBCD (Local2), 0x02), Local2)
                ...
                Store (\_SB.PCI0.LPCB.EC0.ITSN (ToBCD (Local2), 0x04), Local2)
                Concatenate (Local4, Local2, Local3)
                ...
                While (Local1)
                {
                    ...
                    \_SB.PCI0.LPCB.EC0.PBFE (DerefOf (Index (Local0, 0x02)), Local2, Local5)
                    Decrement (Local1)
                    Increment (Local2)
                    Increment (Local4)
                }
                ...
                {
                    Decrement (Local3)
                    Store (DerefOf (Index (TEMP, Local3)), Local2)
                ...
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BCCH, BCCL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x5F))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x5E))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BCVH, BCVL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x61))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x60))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BACH, BACL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x63))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x62))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BREH, BREL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x65))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x64))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BAEH, BAEL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x67))
                Store (Local2, Index (DerefOf (Index (Local0, 0x02)), 0x66))
                Store (\_SB.PCI0.LPCB.EC0.RDMW (BAFH, BAFL), Local1)
                Divide (Local1, 0x0100, Local2, Index (DerefOf (Index (Local0, 0x02)), 
                    0x69))
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Scope (\_TZ)
                {
                    ThermalZone (PGTZ)
                    {
                        ...
                        Method (_TMP, 0, NotSerialized)
                        {
                            If (\_SB.PCI0.LPCB.EC0.ECAV ())
                            {
                                Store (\_SB.PCI0.LPCB.EC0.OCRT, Local2)
                        ...
                        Method (_PSV, 0, NotSerialized)
                        {
                            If (\_SB.PCI0.LPCB.EC0.ECAV ())
                            {
                                Store (\_SB.PCI0.LPCB.EC0.OPSV, CPSV)
                                If (\_SB.PCI0.LPCB.EC0.MOTS)
                                {
                                    If (LEqual (\_SB.PCI0.LPCB.EC0.CSMM, One)) {}
                                    If (LEqual (\_SB.PCI0.LPCB.EC0.CSMM, 0x02)) {}
                                }
                                Else
                                {
                                    If (LEqual (\_SB.PCI0.LPCB.EC0.CSDM, One)) {}
                ...
                Name (OSVT, 0x20)
                Name (OSW7, 0x40)
                OperationRegion (DP80, SystemIO, 0x80, 0x02)
                Field (DP80, WordAcc, NoLock, Preserve)
                {
                    DG16,   16
                }
                ...
                Device (EC0)
                {
                    ...
                    Method (_REG, 2, NotSerialized)
                    {
                        If (LEqual (Arg0, 0x03))
                        {
                            ...
                            If (ECON)
                            {
                                Store (Zero, VBPB)
                                Or (VBPB, EB0T, VBPB)
                                Or (VBPB, ShiftLeft (EB1T, One), VBPB)
                                Store (ACIN, Local0)
                    ...
                    Method (_QA0, 0, NotSerialized)
                    {
                        ...
                        If (ACAP ())
                        {
                            If (LAnd (LEqual (MOTS, One), LNotEqual (CSMM, Zero)))
                            {
                                TURB (Zero)
                    ...
                    Method (_Q33, 0, NotSerialized)
                    {
                        ...
                        If (LEqual (LGS5, Zero))
                        {
                            If (LEqual (LGS4, Zero))
                            {
                                If (LGreaterEqual (Local1, Add (Local2, One)))
                                {
                                    Store (One, LGS5)
                                    Notify (\_TZ.PGT2, 0x80)
                                }
                    ...
                    {
                        Store (Zero, Local1)
                        Store (RDMB (Arg0, Arg1), Local0)
                        Increment (Arg1)
                        Store (RDMB (Arg0, Arg1), Local1)
                    ...
                    Method (RDMS, 3, Serialized)
                    {
                        ...
                        While (Arg2)
                        {
                            Store (RDMB (Arg0, Arg1), Index (TEMM, Local0))
                            Increment (Arg1)
                            Decrement (Arg2)
                            Increment (Local0)
                        }
                    ...
                    Method (DTOS, 1, Serialized)
                    {
                        ...
                        Store ("//////////", YMDS)
                        CreateWordField (YMDS, Zero, MOTH)
                        CreateWordField (YMDS, 0x03, DATE)
                        CreateDWordField (YMDS, 0x06, YEAR)
                        Store (WTOS (Add (ShiftRight (Arg0, 0x09), 0x07BC), 0x04), 
                            YEAR)
                        Store (WTOS (And (ShiftRight (Arg0, 0x05), 0x0F), 0x02), 
                            MOTH)
                    ...
                    {
                        Acquire (ECMX, 0xFFFF)
                        WREC (0x05, 0xF0, And (ShiftRight (Arg0, 0x08), 0xFF))
                        Sleep (0xC8)
                    ...
                    Method (_Q0D, 0, NotSerialized)
                    {
                        Store (0x01AE, HKID)
                        Store (Zero, HKSC)
                        If (LAnd (LNotEqual (OSYS, 0x07D9), LNotEqual (OSYS, 0x07DC)))
                        {
                            ^^^GFX0.GNOT (One, 0x80)
                        }
                    }
                    ...
                    Method (_Q0A, 0, NotSerialized)
                    {
                        ...
                        If (And (DerefOf (Index (Local0, Zero)), 0x02))
                        {
                            Store (One, ^^^^WMID.WED1)
                            Store (One, MOTS)
                            If (LNotEqual (DerefOf (Index (Local0, One)), Zero))
                            {
                                TURB (Zero)
                                If (CondRefOf (\_SB.PCI0.PEG0.PEGP._STA, Local1))
                                {
                                    Notify (^^^PEG0.PEGP, 0xD2)
                                }
                            }
                    ...
                    Method (CSED, 0, Serialized)
                    {
                        If (LOr (LAnd (LEqual (And (GL02, 0x40), 0x40), LEqual (
                            And (GL08, 0x20), 0x20)), LAnd (LEqual (And (GL02, 0x40), 
                            Zero), LEqual (And (GL08, 0x20), 0x20))))
                        {
                            If (WLLO)
                            {
                                Return (Zero)
                    ...
                    Method (GSMA, 0, NotSerialized)
                    {
                        If (ACAP ())
                        {
                            Store (MMRD (0x05, 0xA0), SMTA)
                            If (LEqual (SMTA, 0x02))
                            {
                                Store (Subtract (SizeOf (\_PR.CPU0._PSS), One), \_PR.CPU0._PPC)
                            }
                            Else
                            {
                                Store (Zero, \_PR.CPU0._PPC)
            ...
            Device (ACEL)
            {
                ...
                Method (_STA, 0, NotSerialized)
                {
                    If (^^LPCB.EC0.ECAV ())
                    {
                        ...
                        {
                            Store (0x0F, Local0)
                            Store (^^LPCB.EC0.ACCR (0x0F), Local1)
                            If (LNotEqual (Local1, 0x33))
                            {
                                Store (Zero, Local0)
                            }
                ...
                Method (CLRI, 0, Serialized)
                {
                    ...
                    If (^^LPCB.EC0.ECAV ())
                    {
                        If (LEqual (^^LPCB.EC0.ACIN, Zero))
                        {
                            If (LEqual (^^LPCB.EC0.BAT0._STA (), 0x1F))
                            {
                ...
                Method (ALWR, 2, NotSerialized)
                {
                    ...
                    If (^^LPCB.EC0.ECAV ())
                    {
                        ...
                        If (CNST)
                        {
                            If (LAnd (LEqual (^^LID0._LID (), Zero), LAnd (LEqual (Arg0, 0x32), LEqual (
                                Arg1, 0xFF))))
                            {
                                Store (Zero, CNST)
                                ^^LPCB.EC0.ACCW (0x25, 0x02)
                                ^^LPCB.EC0.ACCW (0x22, 0x40)
                                Store (One, SIMI)
                            }
                        }
        ...
        Scope (\_SB)
        {
            ...
            Device (WMID)
            {
                                        ...
                                        Else
                                        {
                                            ...
                                            Else
                                            {
                                                ...
                                                Else
                                                {
                                                    ...
                                                    {
                                                        Store (Zero, RTCC)
                                                        CreateField (Arg1, 0x80, Multiply (DASI, 0x08), STDB)
                                                        Return (STDC (STDB))
                                                    }
                                                    Else
                                                    {
                                                                ...
                                                                Else
                                                                {
                                                                    ...
                                                                    Else
                                                                    {
                                                                        ...
                                                                        Else
                                                                        {
                                                                            If (LEqual (_T_0, 0x2B))
                                                                            {
                                                                                CreateByteField (Arg1, 0x10, CCBS)
                                                                                CreateByteField (Arg1, 0x11, CCBC)
                                                                                Store (Zero, RTCC)
                                                                                Return (SBCC (CCBS, CCBC))
                                                                            }
                                                                            Else
                                                                            {
                                                                                If (LEqual (_T_0, 0x2C))
                ...
                Method (GTDC, 1, NotSerialized)
                {
                    ...
                    {
                        Store (Zero, Local2)
                        Store (^^PCI0.LPCB.EC0.TA0R, Local2)
                        Multiply (Local2, 0x64, Local2)
                        Divide (Local2, 0x12C0, Local1, Local2)
                        Store (One, Index (DerefOf (Index (Local0, 0x02)), Zero))
                    ...
                    If (LEqual (Arg0, 0x06))
                    {
                        ...
                        While (^^PCI0.LPCB.I25D) {}
                        Store (Zero, ^^PCI0.LPCB.E25C)
                        While (^^PCI0.LPCB.I25D) {}
                        Store (0x11, ^^PCI0.LPCB.E25C)
                        While (^^PCI0.LPCB.I25D) {}
                        Store (0x000FFFFF, Local1)
                        While (Local1)
                        {
                ...
                Method (STDC, 1, NotSerialized)
                {
                    ...
                    CreateByteField (Arg0, One, WTE1)
                    CreateByteField (Arg0, 0x02, WTE2)
                    CreateByteField (Arg0, 0x03, WTE3)
                    CreateByteField (Arg0, 0x04, WTE4)
                    Name (SUCC, Zero)
                    If (LGreaterEqual (WTE1, 0x02))
                    {
                        Return (Package (0x02)
                        {
                            0x06, 
                    ...
                    If (LEqual (SUBC, 0x20))
                    {
                        ...
                        Store (One, TMLS)
                        Store (One, SUCC)
                        If (LGreater (WCTS, 0x32))
                        {
                            ^^PCI0.LPCB.EC0.EFAN (0x64)
                        }
                        Else
                        {
                ...
                Method (BBHT, 0, NotSerialized)
                {
                    ...
                    CreateWordField (DerefOf (Index (Local0, 0x02)), Zero, ID00)
                    Store (0x0131, ID00)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x02, ID01)
                    Store (0x01AE, ID01)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x04, ID02)
                    Store (0x0267, ID02)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x06, ID03)
                    Store (0x0265, ID03)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x08, ID04)
                    Store (0x0268, ID04)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x0A, ID05)
                    Store (0x026B, ID05)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x0C, ID06)
                    Store (0x026C, ID06)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x0E, ID07)
                    Store (0x026A, ID07)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x10, ID08)
                    Store (0xFFFF, ID08)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x12, ID09)
                    Store (0x219C, ID09)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x14, ID0A)
                    Store (0x21A9, ID0A)
                    CreateWordField (DerefOf (Index (Local0, 0x02)), 0x16, ID0B)
                    Store (Zero, ID0B)
                    Return (Local0)
                }
                ...
                Method (GWDI, 0, NotSerialized)
                {
                    ...
                    If (LNotEqual (WLVD, Zero))
                    {
                        ...
                        Store (And (WLVD, 0xFF), Index (DerefOf (Index (Local0, 0x02
                            )), Add (Multiply (Local2, 0x10), 0x02)))
                        Store (ShiftRight (And (WLVD, 0xFF00), 0x08), Index (DerefOf (
                            Index (Local0, 0x02)), Add (Multiply (Local2, 0x10), 0x03)
                            ))
                        Store (And (WLDD, 0xFF), Index (DerefOf (Index (Local0, 0x02
                            )), Add (Multiply (Local2, 0x10), 0x04)))
                        Store (ShiftRight (And (WLDD, 0xFF00), 0x08), Index (DerefOf (
                            Index (Local0, 0x02)), Add (Multiply (Local2, 0x10), 0x05)
                            ))
                        Store (And (WLSV, 0xFF), Index (DerefOf (Index (Local0, 0x02
                            )), Add (Multiply (Local2, 0x10), 0x06)))
                        Store (ShiftRight (And (WLSV, 0xFF00), 0x08), Index (DerefOf (
                            Index (Local0, 0x02)), Add (Multiply (Local2, 0x10), 0x07)
                            ))
                        Store (And (WLSS, 0xFF), Index (DerefOf (Index (Local0, 0x02
                            )), Add (Multiply (Local2, 0x10), 0x08)))
                        Store (ShiftRight (And (WLSS, 0xFF00), 0x08), Index (DerefOf (
                            Index (Local0, 0x02)), Add (Multiply (Local2, 0x10), 0x09)
                            ))
                        Store (Subtract (Local2, One), Index (DerefOf (Index (Local0, 0x02
                            )), Add (Multiply (Local2, 0x10), 0x0A)))
                        Store (0x04, Local1)
                        If (^^PCI0.LPCB.EC0.ECAV ())
                        {
                            If (^^PCI0.LPCB.EC0.RDWL (Zero))
                            {
                                Or (Local1, One, Local1)
                            }
                        }
                    ...
                    If (LNotEqual (BTVD, Zero))
                    {
                        ...
                        Store (ShiftRight (And (BTVD, 0xFF00), 0x08), Index (DerefOf (
                            Index (Local0, 0x02)), Add (Multiply (Local2, 0x10), 0x03)
                            ))
                        Store (And (BTDD, 0xFF), Index (DerefOf (Index (Local0, 0x02
                            )), Add (Multiply (Local2, 0x10), 0x04)))
                        Store (ShiftRight (And (BTDD, 0xFF00), 0x08), Index (DerefOf (
                            Index (Local0, 0x02)), Add (Multiply (Local2, 0x10), 0x05)
                            ))
                        Store (Zero, Index (DerefOf (Index (Local0, 0x02)), Add (Multiply (
                            Local2, 0x10), 0x06)))
                ...
                Method (SWDS, 1, NotSerialized)
                {
                    Name (PCN, Zero)
                    Name (RDS, Zero)
                    Store (ShiftRight (And (Arg0, 0x00FF0000), 0x10), PCN)
                    Store (ShiftRight (And (Arg0, 0xFF000000), 0x18), RDS)
                    Store (Zero, Local1)
                    Store (One, Local2)
                    If (LLess (PCN, 0xFE))
                    {
                        Store (Match (WDPC, MEQ, PCN, MTR, Zero, Zero), Local0)
                        If (LEqual (Local0, Zero))
                        {
                            Or (Local1, One, Local1)
                        }
                    ...
                    {
                        Store (Zero, WLAS)
                        If (LNotEqual (DerefOf (Index (WDPC, Zero)), 0x0100))
                        {
                            Or (Local1, One, Local1)
                        }
                ...
                Method (GHKF, 0, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (^^PCI0.LPCB.EC0.HKID, _T_0)
                        If (LEqual (_T_0, 0x01B6))
                        {
                            Store (BRTL, Index (DerefOf (Index (Local0, 0x02)), 0x02))
                        ...
                        Else
                        {
                            ...
                            Else
                            {
                                If (LEqual (_T_0, 0x01AE))
                                {
                                    Store (Zero, Local0)
                                    Store (Zero, Local1)
                                    If (LEqual (And (^^PCI0.GFX0.DD02._DCS (), 0x0F), 0x0F))
                                    {
                                        Or (Local0, One, Local0)
                                    }
                ...
                Method (SHKF, 1, Serialized)
                {
                    ...
                    CreateWordField (DerefOf (Index (Local3, 0x02)), Zero, TMPI)
                    Store (Local0, TMPI)
                    While (One)
                    {
                        Store (Local0, _T_0)
                ...
                Method (WKLB, 0, NotSerialized)
                {
                    ...
                    If (^^PCI0.LPCB.EC0.ECAV ())
                    {
                        If (LEqual (^^PCI0.LPCB.EC0.HKID, 0x21A9))
                        {
                            Store (And (^^PCI0.LPCB.EC0.HKID, 0xFF), Index (DerefOf (Index (Local0, 0x02
                                )), Zero))
                            Store (ShiftRight (And (^^PCI0.LPCB.EC0.HKID, 0xFF00), 0x08), Index (DerefOf (
                ...
                Method (GBCC, 0, NotSerialized)
                {
                    ...
                    If (^^PCI0.LPCB.EC0.ECAV ())
                    {
                        If (LEqual (^^PCI0.LPCB.EC0.BT0A, Zero))
                        {
                ...
                Method (SBCC, 2, Serialized)
                {
                    ...
                    If (^^PCI0.LPCB.EC0.ECAV ())
                    {
                        If (LNot (And (^^PCI0.LPCB.EC0.EPWS, 0x02)))
                        {
                            Return (Package (0x02)
                            {
                                0x36, 
                        ...
                        While (One)
                        {
                            ...
                            If (LEqual (_T_0, Zero))
                            {
                                ^^PCI0.LPCB.EC0.ACEN (One)
                                Sleep (0xC8)
                                ^^PCI0.LPCB.EC0.ECCB (One)
                            }
                            Else
                            {
                                If (LEqual (_T_0, One))
                                ...
                                Else
                                {
                                    If (LEqual (_T_0, 0x02))
                                    {
                                        Store (0x87, ^^PCI0.LPCB.EC0.DIAC)
                                        ^^PCI0.LPCB.EC0.ACEN (Zero)
                                        Sleep (0xC8)
                                        ^^PCI0.LPCB.EC0.ECCB (One)
                                    }
                                    Else
                                    {
                                        If (LEqual (_T_0, 0x03))
                                        {
                                            ^^PCI0.LPCB.EC0.ACEN (One)
                                            Sleep (0xC8)
                                            ^^PCI0.LPCB.EC0.ECCB (Zero)
                                            Sleep (0x03E8)
                                            ^^PCI0.LPCB.EC0.SETC (PCHG)
                                        }
                                        Else
                                        {
                                            If (LEqual (_T_0, 0x04))
                ...
                Method (GTCS, 0, NotSerialized)
                {
                    ...
                    If (^^PCI0.LPCB.EC0.ECAV ())
                    {
                        Store (^^PCI0.LPCB.EC0.COGS (), Local1)
                        ...
                        Store (DerefOf (Index (Local1, 0x02)), Index (DerefOf (Index (Local0, 
                            0x02)), 0x02))
                        Store (DerefOf (Index (Local1, One)), ^^PCI0.LPCB.EC0.CSMM)
                        Store (DerefOf (Index (Local1, 0x02)), ^^PCI0.LPCB.EC0.CSDM)
                        If (And (DerefOf (Index (Local1, Zero)), 0x02))
                        {
                            Store (One, ^^PCI0.LPCB.EC0.MOTS)
                        }
                        Else
                        {
                ...
                Method (STCS, 1, NotSerialized)
                {
                    If (^^PCI0.LPCB.EC0.ECAV ())
                    {
                        Store (ShiftRight (And (Arg0, 0xFF00), 0x08), ^^PCI0.LPCB.EC0.CSMM)
                    ...
                    If (^^PCI0.LPCB.EC0.ECAV ())
                    {
                        If (LAnd (LEqual (^^PCI0.LPCB.EC0.MOTS, One), LNotEqual (^^PCI0.LPCB.EC0.CSMM, Zero)))
                        {
                            TURB (Zero)
                            If (CondRefOf (\_SB.PCI0.PEG0.PEGP._STA, Local0))
                            {
                                Notify (^^PCI0.PEG0.PEGP, 0xD2)
                            }
                        }
                        Else
                        {
    ...
    Method (TURB, 1, Serialized)
    {
        ...
        If (LEqual (Arg0, Zero))
        {
            If (\_SB.PCI0.LPCB.EC0.ECAV ())
            {
                \_SB.PCI0.LPCB.EC0.MMWR (0x0A, One, Or (\_SB.PCI0.LPCB.EC0.MMRD (0x0A, One), 0x02))
            }
        }
    }
    ...
    Scope (_GPE)
    {
        Method (_L13, 0, NotSerialized)
        {
            ...
            Release (\_SB.PCI0.SAT0.PRT4.ZPMX)
            Return (Zero)
        }
    }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (GFX0)
        {
            ...
            Device (DD02)
            {
                ...
                Method (_BCM, 1, Serialized)
                {
                    ...
                    If (LAnd (LGreaterEqual (Arg0, Zero), LLessEqual (Arg0, 0x64)))
                    {
                        ...
                        If (ECCL)
                        {
                            ...
                            {
                                Store (LCDD, _T_1)
                                If (LEqual (_T_1, 0x303CAF06))
                                {
                                    Store (DerefOf (Index (AUOT, Local1)), Local0)
                                }
                                Else
                                {
                                    If (LEqual (_T_1, 0x1475AE0D))
                                    {
                                        Store (DerefOf (Index (CMIT, Local1)), Local0)
                                    }
                                    Else
                                    {
                                        If (LEqual (_T_1, 0x033FE430))
                                        {
                                            Store (DerefOf (Index (LGDT, Local1)), Local0)
                                        }
                                        Else
                                        {
                                            If (LEqual (_T_1, 0x3942A34C))
                                            {
                                                Store (DerefOf (Index (SAMT, Local1)), Local0)
                                            }
                                            Else
                                            {
                ...
                {
                    And (GL00, 0x80, GI07)
                    ShiftRight (GI07, 0x04, GI07)
                    And (GL02, 0x40, GI22)
                    ShiftRight (GI22, 0x04, GI22)
                    And (GL08, 0x20, GI69)
                    ShiftRight (GI69, 0x04, GI69)
                    And (GL08, 0x40, GI70)
                    ShiftRight (GI70, 0x06, GI70)
                    Store (Or (Or (Or (GI07, GI22), GI69), GI70
                        ), Local0)
                    Return (Local0)
                }
